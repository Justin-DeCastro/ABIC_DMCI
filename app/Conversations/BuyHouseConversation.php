...
class BuyHouseConversation extends Conversation
{
    ...
    public function askLocation()
    {
        ...
        $locations = Alder::distinct('location')->get();
        ...
        foreach ($locations as $location) {
            ...
            $locationUrl = route('viewsale', ['id' => $location->id]);
        ...
        $this->say("Below are the available locations with properties for sale: \n{$locationsString}");
