                            ...
                            <table id="cityTable" class="table table-bordered table-hover">
                                ...
                                {{-- <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $alder->price }}</td>
                                        <td>{{ $alder->status }}</td>
                                        <td>{{ $alder->development }}</td>
                                        <td>{{ $alder->units }}</td>
                                        <td>{{ $alder->location }}</td>
                                        <td>{{ $alder->general }}</td>
                                        <td>{{ $alder->building }}</td>
                                        <td>{{ $alder->link }}</td>
                                        <td>{{ $alder->amenities }}</td>
                                        <td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addForLeaseModalLabel">Add New </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="addForLeaseForm" action="{{ route('forleases.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
