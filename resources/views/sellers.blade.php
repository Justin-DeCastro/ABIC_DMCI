    ...
    <div class="property-content">
        ...
        <section class="banner wavy default" id="overview">
            <picture class="coverimage-img">
                ...
                <img src="{{ asset('images/headers/hero-shd.webp')}}" width="1440" height="330" alt="MDN" >
            </picture>
        ...
        <section class="sec-pad read" id="vision">
            <div class="container m-t-40">
                <div class="row">
<div class="col-sm-12">
<h2>Accreditation</h2>
<p><span class="sec-sub-title">All interested sales professionals who intends to be accredited with DMCI Homes will undergo the FOUNDATION TRAINING.</span></p>
<p><strong>FOUNDATION TRAINING</strong> is an accreditation training on DMCI Homes profile and its projects, sales process, and financing schemes. Only trainees who will successfully pass the Accreditation Exam and the Oral Revalidation Exercise will be contracted.</p>
</div>
<div class="col-sm-6">
<h4>Special Training</h4>
<p>Based on the identified training needs, our sellers have the opportunity to join special trainings to enhance their salesmanship and professional skills in real estate selling. Some programs may be done by our own In-house Trainers or may be outsourced from other training suppliers, all these to help optimize the potentials of our sellers.</p>
<ul class="list-2">
<li>Account Management Workshop</li>
<li>Effective Business Communication</li>
<li>Sales Funnel Workshop</li>
<li>Project Expertise Training</li>
<li>Team building</li>
<li>Personality Development Workshop</li>
<li>Leadership Edge Workshop</li>
</ul>
</div>
<div class="col-sm-6">
<h4>Events</h4>
<p>More than selling, our salespeople are also invited to the most fun-filled, colorful events and sales assemblies which foster camaraderie and friendly competition between sales teams.</p>
<p>&nbsp;</p>
<p><strong>Schedule of recruitment operations is from Monday to Thursday, 8:30am at the Sales Recruitment Office – Ground Floor DMCI Homes Corporate Center. </strong></p>
<p>&nbsp;</p>
<p><strong>Interested applicants are advised to:</strong></p>
<ul>
<li>Bring a copy of their updated resume</li>
<li>Bring a copy of NBI or Police Clearance (if available)</li>
<li>Be in their business attire</li>
</ul>
<p><strong>&nbsp;</strong></p>
<p><strong>All interested professionals will undergo the following steps:</strong></p>
<ol>
<li>Recruitment Orientation</li>
<li>Initial Interview with Sales Recruitment</li>
<li>Salesmanship Assessment with Sales Training</li>
<li>Final Interview with Project Sales Manager and/or Sales Director</li>
<li>Endorsement to Foundation Training</li>
</ol>
<p>&nbsp;</p>
<p><strong>FOUNDATION TRAINING PROGRAM</strong></p>
<p><strong>Day 1 -&nbsp;</strong>Corporate Orientation<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Project Orientation</p>
<p><strong>Day 2</strong> -&nbsp;Sales Process<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Turnover Process<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; In-House and Bank Financing</p>
<p><strong>Day 3</strong> -&nbsp;Salesmanship<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Sales Support Orientation</p>
<p><strong>Day 4</strong> -&nbsp;Written Exam<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Mock Presentation</p>
</div>
</div>
            </div>
        ...
        <section class="sec-pad sec-default bg-grey">
            <div class="container m-t-40">
                <div class="row">
        ...
        <div class="other-channels">
            <ul>
                <li class="animated hiding" data-animation="fadeInUp">
                    <figure><img class="lazyload" src="{{ asset('images/lazyload.png')}}" data-src="{{ asset('images/icon-call.webp')}}" alt="" width="40" height="40"></figure>
                ...
                <li class="animated hiding" data-animation="fadeInUp">
                    <figure><img class="lazyload" src="{{ asset('images/lazyload.png')}}" data-src="{{ asset('images/icon-email.webp')}}" alt="" width="40" height="40"></figure>
                ...
                <li class="animated hiding" data-animation="fadeInUp">
                    <figure><img class="lazyload" src="{{ asset('images/lazyload.png')}}" data-src="{{ asset('images/calendar.png')}}" alt="" width="40" height="40"></figure>
                ...
                <li class="animated hiding" data-animation="fadeInUp">
                    <figure><img class="whistles-icon lazyload" style="width:60px; margin-left: -8px;" src="{{ asset('images/lazyload.png')}}" data-src="{{ asset('images/whistles.png')}}" alt="" width="40" height="40"></figure>
...
<footer class="sec-pad sec-default" id="footer">
    ...
    <div id="wechat-modal" class="read no-padding" style="display: none;">
        <div class="content">
            <div class="sec-head">
                <figure><img class="lazyload" src="{{asset('images/lazyload.png')}}" data-src="{{asset('images/wechat.png')}}" alt=""></figure>
...
<div class="append-style">
    ...
    <link rel="preload" href="{{asset('css/seller.css')}}" as="style">
    <link rel="stylesheet" href="{{asset('css/eller.css')}}" media="all">
...
<script defer="">
   ...
   var GLOBAL_frontend_get__properties_json = "/get/properties/json";
    ...
    var GLOBAL_APP_REQUEST_GET = "frontend_sellers";
...
<script id="liveagent-esw-script" type="text/javascript" src="https://service.force.com/embeddedservice/5.0/client/liveagent.esw.min.js"></script><form id="fileUploadForm" enctype="multipart/form-data" method="post" target="fileUploadIframe"><input type="file" id="fileSelector" name="file" style="display: none;"><input name="filename" type="hidden"></form><iframe id="fileUploadIframe" name="fileUploadIframe" title="FileUploadFrame" style="display: none;"></iframe><div style="display: none; visibility: hidden;"><script>fbq("track","ViewContent",{value:0,currency:"PHP"});</script></div><div id="batBeacon806585219745" style="width: 0px; height: 0px; display: none; visibility: hidden;"><img id="batBeacon513875703825" width="0" height="0" alt="" src="https://bat.bing.com/action/0?ti=26169032&amp;Ver=2&amp;mid=fb5d4e54-223b-4898-adb0-2149fcba2185&amp;sid=00e372e0cf1511eeb35bb9c5faeb4816&amp;vid=00e39ef0cf1511ee9d27d93e2ab67dea&amp;vids=0&amp;msclkid=N&amp;uach=pv%3D10.0.0&amp;pi=918639831&amp;lg=en-US&amp;sw=1366&amp;sh=768&amp;sc=24&amp;tl=Real%20Estate%20Property%20Sellers%20%7C%20DMCI%20Homes&amp;p=https%3A%2F%2Fwww.dmcihomes.com%2Fsellers&amp;r=https%3A%2F%2Fwww.dmcihomes.com%2F&amp;lt=7230&amp;evt=pageLoad&amp;sv=1&amp;rn=279366" style="width: 0px; height: 0px; display: none; visibility: hidden;"></div><iframe id="esw_storage_iframe" src="https://service.force.com/embeddedservice/5.0/esw.html?parent=https://www.dmcihomes.com/sellers" title="Live Chat Metadata" style="display: none;"></iframe><script type="text/javascript" src="https://d.la1-core1.sfdc-mchho0.salesforceliveagent.com/chat/rest/EmbeddedService/EmbeddedServiceConfig.jsonp?Settings.prefix=EmbeddedService&amp;org_id=00D5g000000J3Js&amp;EmbeddedServiceConfig.configName=WEB_CHAT&amp;callback=embedded_svc.liveAgentAPI.handleChatSettings&amp;version=48"></script><script id="invite-esw-script" type="text/javascript" src="https://service.force.com/embeddedservice/5.0/client/invite.esw.min.js"></script><div class="embeddedServiceHelpButton"><div class="helpButton"><button class="helpButtonEnabled uiButton" href="javascript:void(0)"><span class="embeddedServiceIcon" aria-hidden="true" data-icon="" style="display: inline-block;"></span><span class="helpButtonLabel" id="helpButtonSpan" aria-live="polite" aria-atomic="true"><span class="assistiveText">Live chat:</span><span class="message">Chat with an Expert</span></span></button></div></div><script id="inert-script" type="text/javascript" src="https://service.force.com/embeddedservice/5.0/utils/inert.min.js"></script><script type="text/javascript" src="https://www.google.com/recaptcha/api.js?onload=onloadCallback&amp;render=explicit"></script><div style="visibility: hidden; position: absolute; width: 100%; top: -10000px; left: 0px; right: 0px; transition: visibility 0s linear 0.3s, opacity 0.3s linear 0s; opacity: 0;"><div style="width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 2000000000; background-color: rgb(255, 255, 255); opacity: 0.5;"></div><div style="margin: 0px auto; top: 0px; left: 0px; right: 0px; position: fixed; border: 1px solid rgb(204, 204, 204); z-index: 2000000000; background-color: rgb(255, 255, 255);"><iframe title="recaptcha challenge expires in two minutes" name="c-ua6e4ngiiynn" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" src="https://www.google.com/recaptcha/api2/bframe?hl=en&amp;v=1kRDYC3bfA-o6-tsWzIBvp7k&amp;k=6LcKHRwiAAAAAPmLGJqTqV37DxkqG59azLwp8v6-" style="width: 100%; height: 100%;"></iframe></div></div></body></html>
