...
<li>While building an organization that espouses Integrity, Excellence and Interdependence</li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="sec-head">
                    <h2 class="sec-title">DMCI &amp; CREED</h2>
                    @if($abouts->isEmpty())
                        <p>No about information found.</p>
                    @else
                        @foreach ($abouts as $about)
                            <p>{{ $about->we_believe }}</p>
                            <!-- Add other fields similarly -->
                        @endforeach
                    @endif
                </div>
        ...
        {{-- <div class="container">
            ...
            <!-- <div class="slant-border slant-bot slant-blue slant-left pos-a"></div> -->
        </section>
    </div>
            ...
            <ul class="flex card-list" id="core-values-wrapper">
                <li class="box-card">
                    <figure class="property-img">
                        <a href="#">
                            <span class="text-top">Interdependence</span>
                            <img class="lazyloaded" src="{{ asset('images/core-values-interdependence.jpg')}}" data-src="{{ asset('images/core-values-interdependence.jpg')}}" alt="/uploads/media/core-values-interdependence" width="215" height="150">
                        </a>
                    </figure>
                    <div class="content">
                        <p>With unity in purpose and mutual trust and respect for each other, we work toward shared aspirations and transcend boundaries along functional and organizational lines.</p>
                    </div>
                </li>
                <li class="box-card">
                    <figure class="property-img">
                        <a href="#">
                            <span class="text-top">Customer Orientation</span>
                            <img class="lazyloaded" src="{{ asset('images/core-values-customer-orientation.jpg')}}" data-src="{{ asset('images/core-values-customer-orientation.jpg')}}" alt="/uploads/media/core-values-customer-orientation" width="215" height="150">
                        </a>
                    </figure>
                    <div class="content">
                        <p>Our goal is to delight and please our customers. Thus, all activities and programs we undertake result in innovative projects and in the enhancement of productivity and quality.</p>
                    </div>
                </li>
                <li class="box-card">
                    <figure class="property-img">
                        <a href="#">
                            <span class="text-top">Excellence</span>
                            <img class="lazyloaded" src="{{ asset('images/core-values-excellence.jpg')}}" data-src="{{ asset('images/core-values-excellence.jpg')}}" alt="/uploads/media/core-values-excellence" width="215" height="150">
                        </a>
                    </figure>
                    <div class="content">
                        <p>We reject mediocrity and strive for excellence in even the smallest of details.</p>
                    </div>
                </li>
                <li class="box-card">
                    <figure class="property-img">
                        <a href="#">
                            <span class="text-top">Integrity</span>
                            <img class="lazyloaded" src="{{ asset('images/core-values-1550807898224.jpg')}}" data-src="{{ asset('images/core-values-1550807898224.jpg')}}" alt="/uploads/media/core-values-1550807898224" width="215" height="150">
                        </a>
                    </figure>
                    <div class="content">
                        <p>All our actions are guided by what is ethical, fair, and right. Believing in profit with honor, we are committed to good governance and the highest moral standards.</p>
                    </div>
                </li>
            </ul>
        </div>
