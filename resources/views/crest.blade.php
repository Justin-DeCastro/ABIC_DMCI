...
<nav class="rightbar-nav animated fadeInRight visible" data-animation="fadeInRight" data-delay="700">
    ...
    <ul>
        <figure class="rightbar-logo">
            <img class=" lazyloaded" src="{{ asset('images/The Crestmont-logo-large.webp') }}"
                data-src="{{ asset('images/The Crestmont-logo-large.webp') }}" alt="">
        </figure>
...
<section id="main-wrapper">
    ...
    <section class="banner banner single-property-banner jq-section" id="overview">
        ...
        <picture class="coverimage-img animated fadeIn visible" data-animation="fadeIn" style="">
            <source type="image/webp" data-src="{{ asset('images/The Crestmont-header-large.webp') }}"
                media="(min-width: 767px)">
            <source type="image/webp" data-src="{{ asset('images/The Crestmont-header-medium.webp') }}"
                media="(min-width: 320px)">
            <img class=" ls-is-cached lazyloaded" src="{{ asset('images/The Crestmont-header-large.webp') }}"
            ...
            <div class="table-cell">
                <div class="container">
                    <figure class="banner-logo animated fadeInUp visible" data-animation="fadeInUp">
                        <img class=" lazyloaded" src="{{ asset('images/The Crestmont-headerLogo-small.webp') }}"
                            data-src="{{ asset('images/The Crestmont-headerLogo-small.webp') }}" alt="">
                    </figure>
            ...
            <div class="master-plan-wrapper landscape">
                ...
                <div class="master-plan-img-wrapper animated fadeInUp visible" data-animation="fadeInUp">
                    <div class="master-plan-img" id="container-360">
                        <a data-fancybox=""
                            data-src="{{ asset('images/The Crestmont-master-plan-1565058300234-large.webp') }}">
                            <img class="mp-initial lazyloaded"
                                src="{{ asset('images/The Crestmont-master-plan-1565058300234-large.webp') }}"
                                data-src="{{ asset('images/The Crestmont-master-plan-1565058300234-large.webp') }}"
                                alt="">
                        </a>
                    </div>
    ...
    <section class="sec-pad sec-default jq-section" id="units">
        <div class="container">
            <div class="sec-head">
                ...
                <p>Can't find the unit you want? <a href="#contact-form" class="jq-sec"><strong>Leave us your
                            info</strong></a> and be the first to know when one becomes available!</p>
        ...
        <div class="container disclaimer-wrap">
            ...
            <div class="disclaimer-box">
                <p><strong>Disclaimer:</strong> In its continuing desire to improve the project, DMCI Homes reserves the
                    right to change product features, prices, and terms without prior notice and approval. Floor plans
                    and perspectives depicted are for demonstration purposes only and should not be relied upon as final
                    project plans. <strong><a href="#contact-form" class="jq-sec">Contact us for the most updated
                            project information.</a></strong></p>
            </div>
        </div>
...
<div id="batBeacon535899175459" style="width: 0px; height: 0px; display: none; visibility: hidden;"><img
        id="batBeacon691447767294" width="0" height="0" alt=""
        src="https://bat.bing.com/action/0?ti=26169032&amp;Ver=2&amp;mid=b1258e8f-a839-432a-ae6c-b1397a066a83&amp;sid=5615a740d95f11eeb8eaf1978d21fb19&amp;vid=00e39ef0cf1511ee9d27d93e2ab67dea&amp;vids=0&amp;msclkid=N&amp;uach=pv%3D10.0.0&amp;pi=918639831&amp;lg=en-US&amp;sw=1366&amp;sh=768&amp;sc=24&amp;tl=The%20Crestmont%20%7C%20Quezon%20City%20%7C%20Official%20DMCI%20Homes&amp;p=https%3A%2F%2Fwww.dmcihomes.com%2Fthe-crestmont&amp;r=https%3A%2F%2Fwww.dmcihomes.com%2F&amp;lt=1574&amp;evt=pageLoad&amp;sv=1&amp;rn=719009"
...
<form id="fileUploadForm" enctype="multipart/form-data" method="post" target="fileUploadIframe"><input
    ...
    src="https://service.force.com/embeddedservice/5.0/esw.html?parent=https://www.dmcihomes.com/the-crestmont"
...
<div
    ...
    <div style="z-index: 2000000000; position: relative;"><iframe title="recaptcha challenge expires in two minutes"
            name="c-l9y4pqpqmps3" frameborder="0" scrolling="no"
