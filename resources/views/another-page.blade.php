...
<body <!--Start of Tawk.to Script-->
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/645eebbdad80445890ecad0a/1hn50hc6j';
            s1.charset = 'UTF-8';
    ...
    <section id="main-container" class="">
        ...
        <header id="config-header">
            <div class="top-menu">
                <div class="container clearfix">
                    <a href="/">
                        <img src="{{ asset('images/logo-dmci.png') }}" class=" ls-is-cached lazyloaded"
                            alt="DMCI Homes Logo" width="140" height="31">
                        <img class="logo-exclusive lazyload" style="display: none;" src="{{ asset('images/ex.png') }}"
        ...
        <div class="sidebar-menu">
            <figure class="logo">
                <a href="index2.html">
                    <img src="{{ asset('images/dmci.png') }}" class="lazyload" alt="DMCI Homes Logo" width="140"
                        height="31">
                    <img class="lazyload logo-exclusive" style="display: none;"
                        data-src="{{ asset('images/ex.png') }}" alt="DMCI Homes Exclusive Logo" width="400"
                        height="105">
                </a>
            </figure>
            <nav class="main-nav">
                <ul>
                    ...
                    <li class="has-sub"><a href="{{ route('prop') }}"
                            id="property-sidebar-list-button">Properties</a></li>
                ...
                <div class="container">
                    ...
                    <form action="https://www.dmcihomes.com/property-finder">
                        ...
                        <div class="input-wrap text-center not-this">
                            ...
                            <a href="index4.html" advance-lease-button data-search-option="lease"
                        ...
                        <div class="banner-left">
                            ...
                            <div class="banner-text animated hiding" data-animation="fadeInUp" data-delay="300">
                                ...
                                <p id="dynamic-banner-subHeadLine">Mulberry Place is an Asian-Tropical development
                                    ...
                                    grandeur.</p>
                                <a href="mulberry-place.htm" class="btn btn-round" id="dynamic-banner-cta">Visit
                                    Mulberry Place</a>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <div class="bf-bot-wrap">
                                    ...
                                    <div class="bf-looking">
                                        ...
                                        <div class="fr">
                                            <a href="#" class="advance-filter-link"><span
                                                    class="icon-home icon-advancefilter"></span>More Search Options</a>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <a href="#" data-search-option="lease" class="btn btn-block"
                                            id="search-lease-simple-button">Search</a>
                                        <a href="#" data-search-option="buy" class="btn btn-block"
                                            id="search-simple-button">Search</a>
            ...
            <div class="container">
                <div class="sec-head"
                    ...
                    <div class="sec-head-action fr">
                        <a href="properties.htm" class="btn btn-round btn-small">View all Properties</a>
                    </div>
                </div>
                            ...
                            <a href="https://www.dmcihomes.com/the-atherton">
                                <div class="property-item box-card">
                                    <figure class="property-img">
                                        <img class="lazyload" src="{{ asset('images/"lazyload.png') }}"
                                            data-src="https://www.dmcihomes.com/uploads/media/generated/The Atherton-featured-1654495936630-small.JPG"
                                            alt="/uploads/media/generated/The Atherton-featured-1654495936630-small.JPG"
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="price"> ₱ 4,030,000 - ₱ 7,968,000</p>
                                        <!-- <span href="/the-atherton" class="btn btn-ghost btn-v-small btn-dark btn-round">Visit</span> -->
                                    </div>
                                </div>
                            </a>
                        </li>
        ...
        <section class="sec-pad sec-default bg-blue">
            <div class="site-progress-wrap animated fadeInUp visible" data-animation="fadeInUp">
                <ul class="site-progress-list" id="site-progress-list">
                    ...
                    <!-- Satori Residences -->
                    <li data-id="53">
                        <a href="/satori-residences#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded"
                                        src="{{ asset('images/Satori Residences-site-progress-data-1706765700016-medium.jpg') }}"
                                        data-src="{{ asset('images/Satori Residences-site-progress-data-1706765700016-medium.jpg') }}"
                                        alt="">
                                    <span class="sp-percent-value" style="height: 88.99%;"></span>
                                    <span class="sp-percentage">88.99%</span>
                                </figure>
                                <label for="">Satori Residences <span>Pasig</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- Allegra Garden Place -->
                    <li data-id="88">
                        <a href="/allegra-garden-place#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded"
                                        src="{{ asset('images/Allegra Garden Place-site-progress-data-1706768875995-medium.jpg') }}"
                                        data-src="{{ asset('images/Allegra Garden Place-site-progress-data-1706768875995-medium.jpg') }}"
                                        alt="">
                                    <span class="sp-percent-value" style="height: 69.31%;"></span>
                                    <span class="sp-percentage">69.31%</span>
                                </figure>
                                <label for="">Allegra Garden Place <span>Pasig</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- The Oriana -->
                    <li data-id="91">
                        <a href="/the-oriana#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded"
                                        src="{{ asset('images/The Oriana-site-progress-data-1707183897529-medium.JPG') }}"
                                        data-src="{{ asset('images/The Oriana-site-progress-data-1707183897529-medium.JPG') }}"
                                        alt="">
                                    <span class="sp-percent-value" style="height: 24.43%;"></span>
                                    <span class="sp-percentage">24.43%</span>
                                </figure>
                                <label for="">The Oriana <span>Quezon City</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- Mulberry Place -->
                    <li data-id="33">
                        <a href="/mulberry-place#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded"
                                        src="{{ asset('images/Mulberry Place-site-progress-data-1707698706731-medium.jpg') }}"
                                        data-src="/uploads/media/generated/Mulberry Place-site-progress-data-1707698706731-medium.jpg"
                                        alt="">
                                    <span class="sp-percent-value" style="height: 5.42%;"></span>
                                    <span class="sp-percentage">5.42%</span>
                                </figure>
                                <label for="">Mulberry Place <span>Taguig</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    ...
                    <li data-id="25">
                        <a href="/kai-garden-residences#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded" src="{{ asset('images/kai.jpg') }}"
                                        data-src="{{ asset('images/kai.JPG') }}" alt="">
                                    <span class="sp-percent-value" style="height: 96.33%;"></span>
                                    <span class="sp-percentage">96.33%</span>
                                </figure>
                                <label for="">Kai Garden Residences <span>Mandaluyong</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- Fairlane Residences -->
                    <li data-id="17">
                        <a href="/fairlane-residences#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded" src="{{ asset('images/fair.jpg') }}"
                                        data-src="{{ asset('images/fair.jpg') }}" alt="">
                                    <span class="sp-percent-value" style="height: 99.91%;"></span>
                                    <span class="sp-percentage">99.91%</span>
                                </figure>
                                <label for="">Fairlane Residences <span>Pasig</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- Prisma Residences -->
                    <li data-id="43">
                        <a href="/prisma-residences#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded" src="{{ asset('images/prisma.jpg') }}"
                                        data-src="{{ asset('images/prisma.jpg') }}" alt="">
                                    <span class="sp-percent-value" style="height: 99.57%;"></span>
                                    <span class="sp-percentage">99.57%</span>
                                </figure>
                                <label for="">Prisma Residences <span>Pasig</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- The Erin Heights -->
                    <li data-id="113">
                        <a href="/the-erin-heights#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded" src="{{ asset('images/erin.jpg') }}"
                                        data-src="{{ asset('images/erin.jpg') }}" alt="">
                                    <span class="sp-percent-value" style="height: 23.38%;"></span>
                                    <span class="sp-percentage">23.38%</span>
                                </figure>
                                <label for="">The Erin Heights <span>Quezon City</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- Sage Residences -->
                    <li data-id="75">
                        <a href="/sage-residences#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded" src="{{ asset('images/sage.png') }}"
                                        data-src="{{ asset('images/sage.png') }}" alt="">
                                    <span class="sp-percent-value" style="height: 10.24%;"></span>
                                    <span class="sp-percentage">10.24%</span>
                                </figure>
                                <label for="">Sage Residences <span>Mandaluyong</span></label>
                                <p class="update-date">January 31, 2024</p>
                            </div>
                        </a>
                    </li>
                    ...
                    <li data-id="89">
                        <a href="/sonora-garden-residences#site-progress" class="site-progress-item"
                            data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded" src="{{ asset('images/sonora.jpg') }}"
                                        data-src="{{ asset('images/sonora.jpg') }}" alt="">
                                    <span class="sp-percent-value" style="height: 49.27%;"></span>
                                    <span class="sp-percentage">49.27%</span>
                                </figure>
                                <label for="">Sonora Garden Residences <span>Las Piñas</span></label>
                                <p class="update-date">January 25, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- Cameron Residences -->
                    <li data-id="84">
                        <a href="/cameron-residences#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded"
                                        src="{{ asset('images/Cameron Residences-site-progress-data-1707814819434-medium.jpg') }}"
                                        data-src="{{ asset('images/Cameron Residences-site-progress-data-1707814819434-medium.jpg') }}"
                                        alt="">
                                    <span class="sp-percent-value" style="height: 80.99%;"></span>
                                    <span class="sp-percentage">80.99%</span>
                                </figure>
                                <label for="">Cameron Residences <span>Quezon City</span></label>
                                <p class="update-date">January 25, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- The Aston Place -->
                    <li data-id="69">
                        <a href="/the-aston-place#site-progress" class="site-progress-item" data-progress="80">
                            <div class="box-card">
                                <figure class="site-progress-bg">
                                    <img class="ls-is-cached lazyloaded" src="{{ asset('images/aston.png') }}"
                                        data-src="{{ asset('images/The Aston Place-site-progress-data-1707814053122-medium.jpg') }}"
                                        alt="">
                                    <span class="sp-percent-value" style="height: 85.95%;"></span>
                                    <span class="sp-percentage">85.95%</span>
                                </figure>
                                <label for="">The Aston Place <span>Pasay</span></label>
                                <p class="update-date">January 25, 2024</p>
                            </div>
                        </a>
                    </li>
                    <!-- Add more site progress items similarly -->
                </ul>
            </div>
        </section>
                ...
                <div class="grid" id="featured-news-wrapper">
                    ...
                    <div class="grid-item grid-item--width2" data-animation="fadeInUp">
                       ...
                       <article class="article-item featured-article">
                        <figure class="article-img">
                            <img class="ls-is-cached lazyloaded" src="{{ asset($latestNewsUpdate->image) }}" alt="{{ $latestNewsUpdate->name }}" width="485" height="310">
                        </figure>
                        <div class="article-info">
                            <p class="tag">
                                <a href="{{ $latestNewsUpdate->link }}">The Aston Place</a>
                            </p>
                            <h2 class="article-title"><a href="{{ $latestNewsUpdate->link }}">{{ $latestNewsUpdate->name }}</a></h2>
                            <p class="date-published">{{ $latestNewsUpdate->date }}</p>
                            <div class="clr"></div>
                            <p>{{ $latestNewsUpdate->description }}</p>
                        </div>
                    </article>
                </div>
                    ...
                    <div class="grid-item " data-animation="fadeInUp">
                        ...
                        <article class="article-item featured-article">
                            ...
                            <div class="article-info">
                                <p class="tag">
                                    <a href="{{ $latestNewsUpdate->link }}">The Mobile</a>
                                </p>
                                <h2 class="article-title"><a href="{{ $latestNewsUpdate->link }}">{{ $latestNewsUpdate->name }}</a></h2>
                                <p class="date-published">{{ $latestNewsUpdate->date }}</p>
                                <div class="clr"></div>
                            ...
                            <div class="article-info ">
                                <p class="tag">
                                    <a href="https://www.dmcihomes.com/satori-residences">Satori Residences</a>

                                    <a
                                        href="https://www.dmcihomes.com/a>

                                                                                            </p>

                                            <h2 class="article-title"><a
                                            href="https://www.dmcihomes.com/whats-new/news/mobile-gaming-pro-lauds-dmci-homes-condos-commercial-grade-fiber-internet-service">Mobile
                                            gaming pro lauds DMCI Homes condos’ commercial-grade fiber internet
                                            service</a></h2>
                                        ...
                                        <p>
                                            ...
                                            MJ, a moderator for a mobile games company, thought he couldn&#039;t move
                                            into his unit at Satori Residences in F. ...</p>
                            </div>
                        </article>
                    </div>
                    <div class="grid-item " data-animation="fadeInUp">
                        ...
                        <article class="article-item article-min">
                            <figure class="article-img ">
                                <a href="https://www.dmcihomes.com/whats-new/news/dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig"
                                    class="">
                                    <img class="lazyload"
                                        src="{{ asset('images/dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig-1707739908458.jpg') }}"
                                        data-src="{{ asset('images/dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig-1707739908458.jpg') }}"
                                        alt="dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig-1707739908458"
                                        width="485" height="310">
                                ...
                                <p class="tag">
                                    ...
                                    <a
                                        href="https://www.dmcihomes.com/a>
                                            ...
                                            <h2 class="article-title"><a
                                            href="https://www.dmcihomes.com/whats-new/news/dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig">DMCI
                                            Homes unveils redevelopment concepts for Acacia Estates township in
                                            Taguig</a></h2>
                                        <p class="date-published">February 12, 2024</p>
                                        <div class="clr"></div>
                                        <p>
                                            ...
                                            Quadruple A developer DMCI Homes has released redevelopment concepts for its
                                            exclusive Acacia Estates township...</p>
                            </div>
                        </article>
                    </div>
                    <div class="grid-item " data-animation="fadeInUp">
                        ...
                        <article class="article-item article-min">
                            <figure class="article-img ">
                                <a href="https://www.dmcihomes.com/whats-new/news/second-building-of-dmci-homes-japanese-garden-themed-condo-starts-accepting-move-ins"
                                    class="">
                                    <img class="lazyload" src="{{ asset('images/kai.jpg') }}"
                                        data-src="{{ asset('images/kai.jpg') }}"
                                        alt="dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig-1707739908458"
                                        width="485" height="310">
                                </a>
                            </figure>
                            <div class="article-info ">
                                <p class="tag">
                                    <a href="https://www.dmcihomes.com/kai-garden-residences">Kai Garden Residences</a>
                                    ...
                                    <a
                                        href="https://www.dmcihomes.com/a>
                                            ...
                                            <h2 class="article-title"><a
                                            href="https://www.dmcihomes.com/whats-new/news/second-building-of-dmci-homes-japanese-garden-themed-condo-starts-accepting-move-ins">Second
                                            building of DMCI Homes&#039; Japanese Garden-themed condo starts accepting
                                            move-ins</a></h2>
                                        <p class="date-published">February 8, 2024</p>
                                        <div class="clr"></div>
                                        <p>
                                            ...
                                            The Icho Building of Kai Garden Residences, DMCI Homes&amp;rsquo; first
                                            Japanese Garden-inspired condominium locat...</p>
                            </div>
                        </article>
                    </div>
                    <div class="grid-item " data-animation="fadeInUp">
                        ...
                        <article class="article-item article-min">
                            <figure class="article-img ">
                                <a href="https://www.dmcihomes.com/whats-new/news/this-triathlete-found-an-ideal-home-in-the-atherton-paranaque-city"
                                    class="">
                                    <img class="lazyload" src="{{ asset('images/this.png') }}"
                                        data-src="{{ asset('images/this.png') }}"
                                        alt="dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig-1707739908458"
                                        width="485" height="310">
                                </a>
                            </figure>
                            <div class="article-info ">
                                <p class="tag">
                                    <a href="https://www.dmcihomes.com/the-atherton">The Atherton</a>
                                    ...
                                    <a
                                        href="https://www.dmcihomes.com/a>
                                            ...
                                            <h2 class="article-title"><a
                                            href="https://www.dmcihomes.com/whats-new/news/this-triathlete-found-an-ideal-home-in-the-atherton-paranaque-city">This
                                            triathlete found an ideal home in The Atherton, Parañaque City</a></h2>
                                        <p class="date-published">February 5, 2024</p>
                                        <div class="clr"></div>
                                        <p>
                                            ...
                                            Lemon Toledo loves to have an active lifestyle. A triathlete, an
                                            obstacle-course racer, a trail runner, a free...</p>
                            </div>
                        </article>
                    </div>
                    <div class="grid-item " data-animation="fadeInUp">
                        ...
                        <article class="article-item article-min">
                            <figure class="article-img ">
                                <a href="https://www.dmcihomes.com/whats-new/news/dmci-homes-the-atherton-condo-in-paranaque-city-saves-energy-using-solar-tube-lighting"
                                    class="">
                                    <img class="lazyload"
                                        src="{{ asset('images/dmci-homes-the-atherton-condo-in-paranaque-city-saves-energy-using-solar-tube-lighting-1706247891829.jpg') }}"
                                        data-src="{{ asset('images/dmci-homes-the-atherton-condo-in-paranaque-city-saves-energy-using-solar-tube-lighting-1706247891829.jpg') }}"
                                        alt="dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig-1707739908458"
                                        width="485" height="310">
                                </a>
                            </figure>
                                ...
                                <p class="tag">
                                    ...
                                    <a
                                        href="https://www.dmcihomes.com/a>
                                            ...
                                            <h2 class="article-title"><a
                                            href="https://www.dmcihomes.com/whats-new/news/dmci-homes-the-atherton-condo-in-paranaque-city-saves-energy-using-solar-tube-lighting">DMCI
                                            Homes’ The Atherton condo in Parañaque City saves energy using solar tube
                                            lighting</a></h2>
                                        <p class="date-published">January 26, 2024</p>
                                        <div class="clr"></div>
                                        <p>
                                            ...
                                            Always seeking new ways to innovate, Quadruple A developer DMCI Homes
                                            continues to explore new technologies to...</p>
                            </div>
                        </article>
                    </div>
                    <div class="grid-item " data-animation="fadeInUp">
                        ...
                        <article class="article-item article-min">
                            <figure class="article-img ">
                                <a href="https://www.dmcihomes.com/whats-new/news/dmci-homes-marubeni-corp-launch-jv-project-in-pasig-citys-thriving-c-5-ortigas-corridor"
                                    class="">
                                    <img class="lazyload"
                                        src="{{ asset('images/dmci-homes-marubeni-corp-launch-jv-project-in-pasig-citys-thriving-c-5-ortigas-corridor-1706163242188.jpg') }}"
                                        alt="dmci-homes-unveils-redevelopment-concepts-for-acacia-estates-township-in-taguig-1707739908458"
                                        width="485" height="310">
                                </a>
                            </figure>
                            <div class="article-info ">
                                <p class="tag">
                                    <a href="https://www.dmcihomes.com/the-valeron-tower">The Valeron Tower</a>
                                    ...
                                    <a
                                        href="https://www.dmcihomes.com/a>
                                            ...
                                            <h2 class="article-title"><a
                                            href="https://www.dmcihomes.com/whats-new/news/dmci-homes-marubeni-corp-launch-jv-project-in-pasig-citys-thriving-c-5-ortigas-corridor">DMCI
                                            Homes, Marubeni Corp. launch JV project in Pasig City&#039;s thriving C-5
                                            Ortigas Corridor</a></h2>
                                        <p class="date-published">January 25, 2024</p>
                                        <div class="clr"></div>
                                        <p>
                                            ...
                                            DMCI Homes, the Philippines leading developer of resort-inspired condominium
                                            communities, and Japanese global ...</p>
                            </div>
                        </article>
                    </div>
                </div>
