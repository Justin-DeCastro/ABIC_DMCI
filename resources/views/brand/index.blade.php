                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateBrandModal{{ $brand->id }}">
                                                Update
                                            </button>

                                            <!-- Button trigger modal for delete -->
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteBrandModal{{ $brand->id }}">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addBrandForm" action="{{ route('brand.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
