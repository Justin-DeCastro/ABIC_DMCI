...
<head>
    ...
    <title>Property Finder | DMCI Homes</title>
    <meta name="description"
        content="Looking for the perfect residence? DMCI Homes&#039; Property Finder gives you a range of condo homes and residences fit for your needs here. Try it now!">
    <link rel="canonical" href="https://www.dmcihomes.com/property-finder">

    <meta property="og:title" content="Property Finder | DMCI Homes">
    <meta property="og:description"
        content="Looking for the perfect residence? DMCI Homes&#039; Property Finder gives you a range of condo homes and residences fit for your needs here. Try it now!">
    <meta property="og:image"
        content="https://www.dmcihomes.com/uploads/media/generated/Mulberry Place-featured-1665479476736-large.jpg">

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@dmcihomes" />

    <meta name="twitter:title" content="Property Finder | DMCI Homes" />
    ...
    <meta property="og:url"
        content="https://www.dmcihomes.com/property-finder?search=simple&amp;min=1&amp;max=20&amp;type=any&amp;location=any">
    ...
    <link rel="preload" as="font" href="https://fonts.gstatic.com/s/molengo/v9/I_uuMpWeuBzZNBtQXbNakwKso5c.woff2"
        crossorigin>
    <link rel="preload" as="font"
        href="https://fonts.gstatic.com/s/roboto/v18/KFOlCnqEu92Fr1MmSU5fBBc4AMP6lQ.woff2" crossorigin>
    <link rel="preload" as="font" href="https://fonts.gstatic.com/s/roboto/v18/KFOmCnqEu92Fr1Mu4mxKKTU1Kg.woff2"
        crossorigin>
    <link rel="preload" as="font"
        href="https://fonts.gstatic.com/s/roboto/v18/KFOlCnqEu92Fr1MmWUlfBBc4AMP6lQ.woff2" crossorigin>
    ...
    <style>
        ...
        * {
        ...
        .sidebar-menu {
            ...
            background-image: url(/frontend/images/page_template/menu-img-bck.jpg);
    ...
    <script type="application/ld+json">
    {
        "@context": "http://schema.org",
        "@type": "WebPage",
        "name": "Property Finder | DMCI Homes",
        "description": "Looking for the perfect residence? DMCI Homes&#039; Property Finder gives you a range of condo homes and residences fit for your needs here. Try it now!"
    }
    </script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-4DFQ" height="0" width="0"
    ...
    <section id="main-container" class="">
                            ...
                            <div class="custom-checkbox">
                                ...
                                <label for="cookies-ads"
                                    ...
                                    cookies to give you the best experience of our Website. You are consenting to our <a
                                        href="#privacy-policy" data-fancybox><strong>Privacy Policy</strong></a> and
                                    use of cookies if you continue to use the Website.</label>
                            </div>
                        </div>
                        <div class="input-wrap">
                            <a href="#" class="btn btn-block" id="save-profile">Start Browsing</a>
                            <p class="text-center skip-wrap"><a href="" id="skip-profile"
        ...
        <header id="config-header">
            <div class="top-menu">
                <div class="container clearfix">
                    <figure class="logo">
                        <a href="/">
                            <img src="/frontend/images/page_template/logo-dmci.webp" class="lazyload"
                                alt="DMCI Homes Logo" width="140" height="31">
                            <img class="logo-exclusive lazyload" style="display: none;"
                                src="/frontend/images/page_template/dmci-exclusive-logo.png"
        ...
        <div class="sidebar-menu">
            <figure class="logo">
                <a href="/">
                    <img src="/frontend/images/page_template/logo-dmci.webp" alt="DMCI Homes Logo" width="170"
                        height="37">
                    <img class="lazyload logo-exclusive" style="display: none;"
                        data-src="/frontend/images/page_template/dmci-exclusive-logo.png"
                        alt="DMCI Homes Exclusive Logo" width="400" height="105">
                </a>
            </figure>
            <nav class="main-nav">
                ...
                <ul class="nav-other-site">
                    ...
                    <li class="mn-blue mn-btn"><a href="https://leasing.dmcihomes.com/" target="_blank">Leasing <br>
                            Services<span class="icon-home icon-leasing"></span></a></li>
                    <li class="mn-white mn-btn"><a href="https://communities.dmcihomes.com/" target="_blank">DMCI
                            <br>Communities
                            <span class="icon-communitys">
                                <img class="lazyload" src="/frontend/images/page_template/lazyload.png"
                                    data-src="/frontend/images/page_template/community-icon.webp" width="40"
                                    height="17" alt="">
                                <img class="lazyload exclusive" style="display: none;"
                                    src="/frontend/images/page_template/lazyload.png"
                                    data-src="/frontend/images/page_template/community-icon-white.png" width="40"
                                    height="17" alt="">
                            </span>
                        </a>
                    </li>
        ...
        <section id="main-wrapper">
            ...
            <section class="banner sec-pad wavy default" id="overview">
                <picture class="coverimage-img">
                    <source srcset="/frontend/images/headers/hero-shd.webp" media="(min-width: 570px)">
                    <source srcset="/frontend/images/headers/hero-shd.webp" media="(min-width: 320px)">
                    <img src="/frontend/images/headers/hero-shd.webp" width="1440" height="330" alt="MDN">
                </picture>
            ...
            <section class="sec-pad property-finder sec-default">

                <div class="folio-map-filter-wrapper">
                    <div class="container">
                        <div class="folio-map-filter fl" id="advance-filter">
                            <ul class="flex">
                                <li><a href="#"
                                        class="btn btn-large btn-round btn-ghost btn-dark filter-trigger"
                                        data-filter="tform-loc">Cities</a></li>
                                <!-- <li class="mob-only"><a href="#" class="btn btn-large btn-round btn-ghost btn-dark mobile-filter-trigger" data-filter="tform-loc">Cities</a></li> -->
                                <li><a href="#"
                                        class="btn btn-large btn-round btn-ghost btn-dark filter-trigger"
                                        data-filter="tform-types">Types</a></li>
                                <!-- <li class="mob-only"><a href="#" class="btn btn-large btn-round btn-ghost btn-dark mobile-filter-trigger" data-filter="tform-types">Types</a></li> -->
                                <li data-filter="tform-status"><a href="#"
                                        class="btn btn-large btn-round btn-ghost btn-dark filter-trigger"
                                        data-filter="tform-status">Status</a></li>
                                <li><a href="#"
                                        class="btn btn-large btn-round btn-ghost filter-trigger btn-dark"
                                        data-filter="tform-dev">Development Type</a></li>
                                <!-- <li class="mob-only"><a href="#" class="btn btn-large btn-round btn-ghost btn-dark mobile-filter-trigger" data-filter="tform-dev">Development</a></li> -->
                                <li><a href="#"
                                        class="btn btn-large btn-round btn-ghost filter-trigger btn-dark"
                                        data-filter="tform-price">Price</a></li>
                                <!-- <li class="mob-only"><a href="#" class="btn btn-large btn-round btn-ghost btn-dark mobile-filter-trigger" data-filter="tform-price">Price</a></li> -->

                            </ul>
                        </div>

                        <!-- <div class="advanced-filter fr">
                <a href="#" class="advance-filter-link"><span class="icon-advancefilter"></span> Advance Filters</a>
            </div> -->
                ...
                <div class="ff-dropdown-wrap">
                    <div class="container">
                        <div class="tform tform-loc" id="tform-loc">
                            <div class="input-wrap">
                                <ul class="flex check" id="simple-filter-city">
                                </ul>
                                <hr>
                                <div class="">
                                    <span class="btn-text fl property-count-btn" disabled></span>
                                    <span class="btn-text fl unit-count-btn" disabled></span>
                                    <button class="btn btn-large btn-round btn-ghost btn-text btn-clear fr"
                                        id="clear-location">Clear</button>
                                    <button class="btn btn-large btn-round btn-ghost btn-text btn-select active fr"
                                        id="select-all-location">Select All</button>

                                    <div class="clr"></div>
                                </div>
                                <button class="btn btn-round btn-blue btn-apply-filter"
                                    id="apply-location">Apply</button>
                            </div>
                        </div>
                        <div class="tform tform-types" id="tform-types">
                            <div class="input-wrap">
                                <ul class="flex check" id="simple-filter-type">
                                </ul>
                                <hr>
                                <div class="">
                                    <span class="btn-text fl property-count-btn" disabled></span>
                                    ...
                                    <button class="btn btn-large btn-round btn-ghost btn-text btn-clear fr"
                                        id="clear-types">Clear</button>
                                    <button class="btn btn-large btn-round btn-ghost btn-text btn-select active fr"
                                        id="select-all-types">Select All</button>

                                    <div class="clr"></div>
                                </div>
                                <button class="btn btn-round btn-blue btn-apply-filter"
                                    id="apply-types">Apply</button>
                            </div>
                        </div>
                        <div class="tform tform-status" id="tform-status">
                            <div class="input-wrap">
                                <ul class="flex check" id="simple-filter-status">
                                </ul>
                                <hr>
                                <div class="">
                                    <span class="btn-text fl property-count-btn" disabled></span>
                                    <span class="btn-text fl unit-count-btn" disabled></span>
                                    <button class="btn btn-large btn-round btn-ghost btn-text btn-clear fr"
                                        id="clear-status">Clear</button>
                                    <button class="btn btn-large btn-round btn-ghost btn-text btn-select active fr"
                                        id="select-all-status">Select All</button>
                                    <div class="clr"></div>
                                </div>
                                <button class="btn btn-round btn-blue btn-apply-filter"
                                    id="apply-status">Apply</button>
                            </div>
                        </div>
                        <div class="tform tform-dev" id="tform-dev">
                            <div class="input-wrap">
                                <ul class="flex check" id="simple-filter-dev">
                                    <li>
                                        <div class="custom-checkbox">
                                            <input class="dev-checkbox" id="dev-2" checked type="checkbox"
                                                name="" value="2">
                                            <label for="dev-2"><strong>High Rise Condominiums</strong></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input class="dev-checkbox" id="dev-3" checked type="checkbox"
                                                name="" value="3">
                                            <label for="dev-3"><strong>Mid Rise Condominiums</strong></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input class="dev-checkbox" id="dev-4" checked type="checkbox"
                                                name="" value="4">
                                            <label for="dev-4"><strong>Subdivisions</strong></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input class="dev-checkbox" id="dev-5" checked type="checkbox"
                                                name="" value="5">
                                            <label for="dev-5"><strong>Leisure Residences</strong></label>
                                        </div>
                                    </li>
                                </ul>
                                <hr>
                                <div class="">
                                    ...
                                    <button class="btn btn-large btn-round btn-ghost btn-text btn-clear fr"
                                        id="clear-dev">Clear</button>
                                    <button class="btn btn-large btn-round btn-ghost btn-text btn-select active fr"
                                        id="select-all-dev">Select All</button>
                                    <div class="clr"></div>
                                </div>
                                <button class="btn btn-round btn-blue btn-apply-filter" id="apply-dev">Apply</button>
                            </div>
                        </div>
                        <div class="tform tform-price" id="tform-price">
                            <div class="input-wrap">
                                ...
                                <div class="price-range">
                                    <div class="price-selectbox">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="custom-select">
                                                    <label for="min-price-select"></label>
                                                    <select name="priceMin" id="min-price-select">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                ...
                                                <div class="custom-select">
                                                    <label for="max-price-select"></label>
                                                    <select name="priceMax" id="max-price-select">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <input type="hidden" id="qs-min-price" name="price_fm" class="price_fm" />
                                    <input type="hidden" id="qs-max-price" name="price_to" class="price_to" />
                                ...
                                <hr>
                                <div class="reset-btn-result">
                                    <span class="btn-text fl property-count-btn" disabled></span>
                                    <span class="btn-text fl unit-count-btn" disabled></span>
                                    <a href="#" class="btn btn-large btn-round btn-ghost btn-text btn-clear fr"
                                        id="reset-price">Reset</a>


                                    <div class="clr"></div>
                                </div>
                                <a href="#" class="btn btn-round btn-blue btn-apply-filter">Apply</a>
                            </div>
                        </div>
                    </div>
                </div>
            </section>
            <section class="sec-pad sec-default search-result">
                <div class="container">
                    <div class="sec-head">
                        <div class="show-map flex fr" style="display: none;">
                            <p>Show Map</p>
                            <span class="fl">
                                <label class="switchbox switchbox-map">
                                    <input type="checkbox" name="">
                                    <span class="switchmark"></span>
                                </label>
                            </span>
                        </div>
                        <div class="sort-wrap sort fr" id="sort-properties">
                            <label for="">Sort By:</label>
                            <div class="custom-select">
                                <label for="result-sort-select"></label>
                                <select name="" id="result-sort-select">
                                    <option class="sort-name" value="name_up">Name A-Z</option>
                                    <option class="sort-name" value="name_down">Name Z-A</option>
                                    <option class="sort-price" value="price_up">Price &#8593;</option>
                                    <option class="sort-price" value="price_down">Price &#8595;</option>
                                </select>
                            </div>
                        </div>

                        <div class="sort-wrap sort fr" id="sort-units" style="display: none;">
                            <label for="">Sort By:</label>
                            <div class="custom-select">
                                <label for="result-sort-select-unit"></label>
                                <select name="" id="result-sort-select-unit">
                                    <option class="sort-name" value="name_up">Name A-Z</option>
                                    <option class="sort-name" value="name_down">Name Z-A</option>
                                    <option class="sort-price" value="price_up">Price &#8593;</option>
                                    <option class="sort-price" value="price_down">Price &#8595;</option>
                                    <option class="sort-size" value="size_up">Size &#8593;</option>
                                    <option class="sort-size" value="size_down">Size &#8595;</option>
                                </select>
                            </div>
                        </div>
                        <div class="change-result">
                            <ul>
                                ...
                                <li class="active result-action"><a class="result-switch" href="#property-list-view"
                                        id="property-result-button">Property</a></li>
                                <li class="result-action"><a class="result-switch" href="#unit-list-view"
                                        id="unit-result-button">Unit</a></li>
                            </ul>
                        </div>
                        <h2 class="fl"><span id="count"></span></h2>
                        <h2 class="fl"><span id="count-units" style="display: none;"></span></h2>
                    </div>
                    <figure class="fetching-loader text-center">
                        <!-- <img src="frontend/images/page_template/loading.gif" width="100" alt=""> -->
                    ...
                    <div class="property-list folio-map" id="property-list-view">
                        <ul class="flex folio" id="property-list-wrapper">
                            <li class="box-card">
                        ...
                        <div class="text-center">
                            <button class="btn btn-large btn-round btn-ghost text-dark" id="show-more-button">Show
                                More</button>
                        </div>
                    </div>


                    <div class="property-list folio-map" id="unit-list-view" style="display: none;">
                        <ul class="flex" id="unit-list-wrapper">
                        </ul>

                        <div class="text-center">
                            <button class="btn btn-large btn-round btn-ghost text-dark"
                                id="show-more-units-button">Show More</button>
                        </div>
            ...
            <section class="sec-pad compare brk active" id="compared-units-wrapper">
                <div class="container">
                    <div class="compare-content">
                        <ul class="flex" id="compared-units">
                        </ul>
                    </div>
                </div>
            </section>
        ...
        <footer class="sec-pad sec-default" id="footer">
            ...
            <div id="qq-modal" class="read no-padding" style="display: none;">
                <div class="content">
                    <div class="sec-head">
                        <figure><img class="lazyload" src="/frontend/images/page_template/lazyload.png"
    ...
    <link rel="preload" href="{{asset('css/property-list-page.css')}}" as="style">
    <link rel="stylesheet" href="{{asset('css/property-list-page.css')}}" media="all" />
    <style>
        @media screen and (min-width: 992px) {
            .reset-btn-result {
                max-width: 545px;
    ...
    <script defer>
        ...
        var GLOBAL_APP_REQUEST_GET = "frontend_properties_finder";
    ...
    <script async>
        $('.switchbox-map input[type="checkbox"]').change(function() {
            $(this).is(":checked") ? ($("#main-wrapper").addClass("map-active-right"), $("#location").removeClass(
                "disabled")) : ($("#main-wrapper").removeClass("map-active-right"), $("#location").addClass(
                "disabled"))
        }), $(".filter-trigger").click(function(b) {
            b.preventDefault();
            var a = $(this).attr("data-filter");
            $(".ff-dropdown-wrap").hasClass("active") ? ($(".filter-trigger").removeClass("btn-selected"), $(
                ".tform").css({
                display: "none"
            }), $("#" + a).css({
                display: "block"
            }), $(this).addClass("btn-selected")) : ($(".filter-trigger").removeClass("btn-selected"), $(
                ".ff-dropdown-wrap").addClass("active"), $(this).addClass("btn-selected"), $(".tform").css({
                display: "none"
            }), $("#" + a).css({
                display: "block"
            }), $(".sec-pad:not(.property-finder)").addClass("overlay"), $(".property-finder").addClass(
                "box-shadow"))
        }), 767 >= $(window).width() && $(".property-list-carousel").owlCarousel({
            center: !1,
            loop: !1,
            margin: 30,
            nav: !0,
    ...
    <script async>
        /* global variable for php code inside search-result.js */
        var comparedProperties, comparedUnits, map, GLOBAL_frontend_properties_cities = "/properties/cities",
            GLOBAL_frontend_properties_unit_types = "/properties/unit/types",
            GLOBAL_frontend_properties_status = "/properties/status",
            GLOBAL_frontend_filter_properties = "/properties/filter",
            GLOBAL_frontend_simple_search_properties = "/properties/search/simple",
            GLOBAL_lazyload_png = "/frontend/images/page_template/lazyload.png",
            page = 1,
            unitPage = 1,
            selectedCities = [],
            selectedCityIds = [],
            selectedTypes = [],
            selectedDev = [2, 3, 4, 5],
            selectedTypeIds = [1, 2, 3, 4, 5, 6, 7, 8],
            selectedStatus = [],
            selectedStatusIds = [1, 2, 3, 4],
            selectedMinPrice = 0,
            selectedMaxPrice = 20,
            properties = [],
            units = [],
            ...
            clearUnits = !0,
            isBusyFetching = !0,
            comparedState = "properties",
            prop_count = 0,
            unit_count = 0;

        function initMap() {
            navigator.geolocation ? navigator.geolocation.getCurrentPosition(showMapFinder, geoFail) : showMapFinder(null)
        }
        ...
        function loadCitiesSearch() {
            $.get(GLOBAL_frontend_properties_cities).done(function(a) {
                var b = $("#simple-filter-city");
                Object.keys(a).forEach(function(d) {
                    var c = a[d],
                        e =
                        '<li><div class="custom-checkbox "><input class="location-checkbox" checked="true" id="loc-' +
                        c.city + '" type="checkbox" name="simple-city-filter" value="' + c.city +
                        '" data-name="' + c.city_name + '" ><label for="loc-' + c.city + '"><strong>' + c
                        .city_name + "</strong></label></div></li>";
                    b.append(e)
                }), $(".location-checkbox").change(function() {
                    page = 1, unitPage = 1, selectedCityIds = [], selectedCities = [], $(".btn-clear").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $(".btn-select").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $("#select-all-location").removeClass("active"), $("#clear-location")
                        .removeClass("active"), $(".btn-apply-filter").addClass("disabled"), $(
                            ".location-checkbox").each(function(c) {
                            if ($(this).is(":checked")) {
                                var a = $(this).val(),
                                    b = $(this).data("name");
                                selectedCityIds.push(a), selectedCities.push(b)
                            }
                        }), 0 === selectedCities.length && (selectedCityIds = [0]), getPropertiesAndUnits()
                }), $("#select-all-location").click(function(a) {
                    a.preventDefault(), $(this).hasClass("active") || !1 !== isBusyFetching || ($(
                            ".btn-clear").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $(".btn-select").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $("#simple-filter-city").find(".location-checkbox").prop("checked", !0), $(
                            ".location-checkbox").each(function(c) {
                            var a = $(this).val(),
                                b = $(this).data("name");
                            selectedCityIds.push(a), selectedCities.push(b)
                        }), getPropertiesAndUnits(), $(this).addClass("active"), $("#clear-location")
                        .removeClass("active"), $(".btn-apply-filter").addClass("disabled"))
                }), $("#clear-location").click(function(a) {
                    a.preventDefault(), $(this).hasClass("active") || !1 !== isBusyFetching || ($(
                            ".unit-count-btn").html("<span>0</span> unit found"), $(
                            ".property-count-btn").html("<span>0</span> property found"), $(
                            "#simple-filter-city").find(".location-checkbox").prop("checked", !1),
                        selectedCityIds = [0], selectedCities = [], $(this).addClass("active"), $(
                            "#select-all-location").removeClass("active"), $(".btn-apply-filter")
                        .addClass("disabled"))
                })
            }).fail(function() {
                alert("error")
        ...
        function loadUnits() {
            $.get(GLOBAL_frontend_properties_unit_types).done(function(a) {
                var b = $("#simple-filter-type");
                Object.keys(a).forEach(function(d) {
                    var c = a[d],
                        e =
                        '<li><div class="custom-checkbox"><input class="types-checkbox" checked="true" id="type-' +
                        c.type + '" type="checkbox" name="simple-type-filter" value="' + c.type +
                        '" data-name="' + c.unit_type + '"><label for="type-' + c.type + '"><strong>' + c
                        .unit_type + "</strong></label></div></li>";
                    b.append(e)
                }), $(".types-checkbox").change(function() {
                    selectedTypeIds = [], selectedTypes = [], unitPage = 1, page = 1, $(".btn-clear").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $(".btn-select").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $("#select-all-types").removeClass("active"), $("#clear-types").removeClass(
                            "active"), $(".btn-apply-filter").addClass("disabled"), $(".types-checkbox")
                        .each(function(c) {
                            if ($(this).is(":checked")) {
                                var a = $(this).val(),
                                    b = $(this).data("name");
                                selectedTypeIds.push(a), selectedTypes.push(b)
                            }
                        }), getPropertiesAndUnits()
                }), $("#select-all-types").click(function(a) {
                    a.preventDefault(), $(this).hasClass("active") || !1 !== isBusyFetching || ($(
                            ".btn-clear").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $("#simple-filter-type").find(".types-checkbox").prop("checked", !0), $(
                            ".types-checkbox").each(function(c) {
                            var a = $(this).val(),
                                b = $(this).data("name");
                            selectedTypeIds.push(a), selectedTypes.push(b)
                        }), getPropertiesAndUnits(), $(this).addClass("active"), $("#clear-types")
                        .removeClass("active"), $(".btn-apply-filter").addClass("disabled"))
                }), $("#clear-types").click(function(a) {
                    a.preventDefault(), $(this).hasClass("active") || !1 !== isBusyFetching || ($(
                            ".unit-count-btn").html("<span>0</span> unit found"), $(
                            ".property-count-btn").html("<span>0</span> property found"), $(
                            "#simple-filter-type").find(".types-checkbox").prop("checked", !1),
                        selectedTypeIds = [], selectedTypes = [], $(this).addClass("active"), $(
                            "#select-all-types").removeClass("active"), $(".btn-apply-filter").addClass(
                            "disabled"))
                })
            }).fail(function() {
                alert("error")
        ...
        function loadStatus() {
            $.get(GLOBAL_frontend_properties_status).done(function(a) {
                var b = $("#simple-filter-status");
                Object.keys(a).forEach(function(f) {
                    var c = a[f],
                        d = "coming-soon",
                        e = "cs";
                    "1" === c.id ? (d = "new", e = "new") : "2" === c.id ? (d = "RFO", e = "rfo") : "3" ===
                        c.id && (d = "under-construction", e = "uc");
                    var g =
                        '<li><div class="custom-checkbox"><input checked="true" class="status-checkbox" id="status-' +
                        c.id + '" type="checkbox" name="simple-status-filter" value="' + c.id +
                        '" data-name="' + c.name + '"><label for="status-' + c.id +
                        '"><span class="property-status"><span class="icon icon-' + d + " " + e +
                        '"></span></span><strong>' + c.name + "</strong></label></div></li>";
                    b.append(g)
                }), $(".status-checkbox").change(function() {
                    selectedStatusIds = [], selectedStatus = [], page = 1, unitPage = 1, $(".btn-clear")
                        .css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $(".btn-select").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), $("#select-all-status").removeClass("active"), $("#clear-status").removeClass(
                            "active"), $(".btn-apply-filter").addClass("disabled"), $(".status-checkbox")
                        .each(function(c) {
                            if ($(this).is(":checked")) {
                                var a = $(this).val(),
                                    b = $(this).data("name");
                                selectedStatusIds.push(a), selectedStatus.push(b)
                            }
                        }), getPropertiesAndUnits()
                }), $("#select-all-status").click(function(a) {
                    $(this).hasClass("active") || !1 !== isBusyFetching || ($(".btn-clear").css({
                            visibility: "hidden",
                            "pointer-event": "none"
                        }), b.find(".status-checkbox").prop("checked", !0), $(".status-checkbox").each(
                            function(c) {
                                var a = $(this).val(),
                                    b = $(this).data("name");
                                selectedStatusIds.push(a), selectedStatus.push(b)
                            }), getPropertiesAndUnits(), $(this).addClass("active"), $("#clear-status")
                        .removeClass("active"), $(".btn-apply-filter").addClass("disabled"))
                }), $("#clear-status").click(function(a) {
                    $(this).hasClass("active") || !1 !== isBusyFetching || ($(".unit-count-btn").html(
                            "<span>0</span> unit found"), $(".property-count-btn").html(
                            "<span>0</span> property found"), b.find(".status-checkbox").prop("checked",
                            !1), selectedStatusIds = [], selectedStatus = [], $(this).addClass(
                        "active"), $("#select-all-status").removeClass("active"), $(".btn-apply-filter")
                        .addClass("disabled"))
                })
            }).fail(function() {
                alert("error")
        ...
        function getPropertiesAndUnits() {
            return new Promise(function(b) {
                $(".btn-apply-filter").prop("disabled", !0), $(".property-count-btn").html(
                        "fetching properties ..."), $(".unit-count-btn").html("fetching units ..."),
                    isBusyFetching = !0;
                var a = {};
                properties = [], units = [], a.city = selectedCityIds, a.status = selectedStatusIds, a.type =
                    selectedTypeIds, a.page = page, a.dev = selectedDev, a.min = selectedMinPrice, a.max =
                    selectedMaxPrice, $.post(GLOBAL_frontend_filter_properties, JSON.stringify(a), "json").done(
                        function(a) {
                            properties = [], units = [];
                            var c = a.properties,
                                d = a.units;
                            Object.keys(c).forEach(function(a) {
                                    ...
                                    var b = d[a];
                                    units.push(b)
                                }), unit_count = a.total_units, $(".unit-count-btn").html("<span>" + unit_count +
                                    "</span> units found"), prop_count = a.total_properties, $(
                                    ".property-count-btn").html("<span>" + prop_count + "</span> properties found"),
                                (prop_count > 0 || unit_count > 0) && $(".btn-apply-filter").prop("disabled", !1),
                                b(a), isBusyFetching = !1, $(".btn-apply-filter").removeClass("disabled"), $(
                                    ".btn-clear").css({
                                    visibility: "visible",
                                    "pointer-event": "auto"
                                }), $(".btn-select").css({
        ...
        function applyFilter() {
            $("#count").html(prop_count + "  properties found"), $("#count-units").html(unit_count + "  units found"),
                loadProperties(), populateUnits(), $("#show-more-button").hide(), $("#show-more-units-button").hide(), $(
                    ".property-finder .jq-close").click(), $(".fetching-loader-filter").removeClass("loading")
        }

        function populateUnits() {
            var a = $("#unit-list-wrapper");
            a.empty(), Object.keys(units).forEach(function(e) {
                var b = units[e],
                    d = "";
                $.grep(comparedUnits, function(a) {
                    return a.id === b.id
                }).length > 0 && (d = "active");
                var c = '<li class="box-card unit-card" data-id="' + b.id + '" data-name="' + b.property_name +
                    '" data-min="' + parseInt(b.min.replace(/,/g, "")) + '" data-max="' + parseInt(b.max.replace(
                        /,/g, "")) + '" data-size="' + parseFloat(b.gfArea) +
                    '">                            <div class="property-item">                            <a href="/' +
                    b.property_slug +
                    '#units">                                <span class="property-status circle-white">                                    <span class="icon-home ' +
                    b.property_status_class + " " + b.property_status_logo +
                    '"></span>                                </span>                                <div class="content">                                    <figure class="unit-logo"><img class="lazyload" src="' +
                    GLOBAL_lazyload_png + '" data-src="' + b.logo +
                    '" alt="" width="220" height="150"></figure>                                    <p class="c-blue">' +
                    b.city + "</p>";
                c = c +
                    '             </div>                                <div class="content-right">                                    <div class="unit-type">                                        <h5>' +
                    b.name + " <span>" + b.gfArea +
                    ' sqm</span></h5>                                        <p class="price"><span class="currency-convert" data-value="' +
                    b.min + '"> PHP ' + b.min + '</span> - <i class="currency-convert" data-value="' + b.max +
                    '">PHP ' + b.max + "</i></p>", b.available <= 10 && (c +=
                        '<p class="few-units-left text-center">Few units left</p>'), c = c +
                    '                                    </div>                                </div>                                <div class="clr"></div>                                <p class="units-compare"><a href="#" data-id="' +
                    b.id + '"  data-name="' + b.name + " (" + b.gfArea + ' sqm)" data-project="' + b.property_name +
                    '"  data-city="' + b.city + '" class="btn-compare-units ' + d +
                    '" ><span class="icon-home icon-add-filter"></span>', "" === d ? c +=
                    "COMPARE WITH OTHER PROPERTIES" : c += '<span class="icon-home icon-check"></span>SELECTED',
                    c += "</a></p></a></div></li>", $(".fetching-loader").remove(), a.append(c), convertCurrencies()
            }), $(".btn-compare-units").click(function(a) {
                a.preventDefault();
                var b = $(this).data("id"),
                    c = $(this).data("name"),
                    d = $(this).data("project"),
                ...
                if ($(this).hasClass("active")) $(this).html("COMPARE WITH OTHER PRoperties"), $(this).removeClass(
                    "active"), comparedUnits = comparedUnits.filter(function(a) {
                    return a.id !== b
                });
                else {
                    var f = 767 > $(window).width() ? 2 : 3;
                    if (comparedUnits.length < f) {
                        $(this).html('<span class="icon-home icon-check"></span>SELECTED'), $(this).addClass(
                            "active");
                        var g = {
                            id: b,
                            name: c,
                        ...
                        comparedUnits.push(g)
                    }
                }
                updateLocalStorage(), populateComparedUnits()
            })
        }

        function searchSimplePropertiesAndUnits() {
            var a = {};
            properties = [], units = [], a.lat = getParameterByName("lat"), a.lng = getParameterByName("lng"), a.min =
                getParameterByName("min"), a.max = getParameterByName("max"), a.unit = [];
            var b = getParameterByName("type");
            "any" === b ? a.unit = [1, 2, 3, 4, 5, 6, 7, 8] : b.includes(",") ? a.unit = b.split(",") : a.unit.push(b), a
                .dev = [1, 2, 3, 4, 5], a.status = [1, 2, 3, 4], $.post(GLOBAL_frontend_simple_search_properties, JSON
                    .stringify(a), "json").done(function(b) {
                    $("#simple-filter-city").find(".location-checkbox").prop("checked", !1), $("#simple-filter-type")
                        .find(".types-checkbox").prop("checked", !1), $("#simple-filter-status").find(
                            ".status-checkbox").prop("checked", !1), $("#simple-filter-dev").find(".dev-checkbox").prop(
                            "checked", !1);
                    var c = b.properties,
                        d = b.units;
                    Object.keys(d).forEach(function(a) {
                        ...
                        var a = c[b];
                        selectedCityIds.includes(a.city_id) || (selectedCityIds.push(a.city_id), selectedCities
                            .push(a.city), $("#simple-filter-city").find("#loc-" + a.city_id).prop(
                                "checked", !0)), properties.push(a)
                    }), a.unit.forEach(function(a) {
                        selectedTypeIds.push(a), $("#simple-filter-type").find("#type-" + a).prop("checked", !0)
                    }), a.dev.forEach(function(a) {
                        selectedTypeIds.push(a), $("#simple-filter-dev").find("#dev-" + a).prop("checked", !0)
                    }), a.status.forEach(function(a) {
                        selectedTypeIds.push(a), $("#simple-filter-status").find("#status-" + a).prop("checked",
                            !0)
                    }), $("#count").html(b.total_properties + "  properties found"), $("#count-units").html(b
                        .total_units + " units found"), loadProperties(), populateUnits();
                    var e = new google.maps.LatLng(Number(a.lat), Number(a.lng));
                    map.setCenter(e), map.setZoom(12), isBusyFetching = !1, $(".btn-apply-filter").removeClass(
                        "disabled"), $(".btn-clear").css({
                        visibility: "visible",
                        "pointer-event": "auto"
                    }), $(".btn-select").css({
                        visibility: "visible",
                        "pointer-event": "auto"
                    }), $(".fetching-loader").remove(), getPropertiesAndUnits()
                })
        }

        function searchAdvancePropertiesAndUnits() {
            var a = {};
            properties = [], a.lat = getParameterByName("lat"), a.lng = getParameterByName("lng"), a.min =
                getParameterByName("min"), a.max = getParameterByName("max"), a.unit = getParameterByName("type").split(
                ","), a.dev = getParameterByName("dev").split(","), a.status = getParameterByName("status").split(","), $
                .post(GLOBAL_frontend_simple_search_properties, JSON.stringify(a), "json").done(function(b) {
                    $("#simple-filter-city").find(".location-checkbox").prop("checked", !1), $("#simple-filter-type")
                        .find(".types-checkbox").prop("checked", !1), $("#simple-filter-status").find(
                            ".status-checkbox").prop("checked", !1), $("#simple-filter-dev").find(".dev-checkbox").prop(
                            "checked", !1);
        ...
        function loadProperties() {
            var a = $("#property-list-wrapper");
            a.empty(), Object.keys(properties).forEach(function(j) {
                var b = properties[j],
                    k = new google.maps.LatLng(Number(b.latitude), Number(b.longitude));
                ...
                var f = "",
                    g = Number(b.price_range[0].min_price),
                    h = Number(b.price_range[0].max_price);
                $.grep(comparedProperties, function(a) {
                    return a.id === b.id
                }).length > 0 && (f = "active");
                var d = "coming-soon",
                    e = "cs";
                1 === b.status ? (d = "new", e = "new") : 2 === b.status ? (d = "RFO", e = "rfo") : 3 === b
                    .status && (d = "under-construction", e = "uc");
                var c = '<li class="p-card box-card" data-id="' + b.id + '" data-city="' + b.city + '" data-min="' +
                    parseInt(b.price_range[0].min_price) + '" data-max="' + parseInt(b.price_range[0].max_price) +
                    '" data-name="' + b.name + '"><a href="#" class="icon-share pi-share" data-url="' + b.slug +
                    '"><span>Share</span></a><div class="property-item" data-lat="' + b.latitude + '" data-lng="' +
                    b.longitude + '"><a href="/' + b.slug +
                    '"><figure class="property-img property-item-image"><img class="lazyload" src="' +
                    GLOBAL_lazyload_png + '" data-src="' + b.image +
                    '" alt="" width="220" height="150"><span class="property-status circle-white"><span class="icon-home ' +
                    e + " icon-" + d + '"></span></span></figure><div class="content"><h3>' + b.name + "</h3><p>" +
                    b.city + '</p><p class="property-type">';
                if (b.is_units_activated) {
                    var i = '<span data-value="' + g + '" class="currency-convert">' + g +
                        '</span> - <span data-value="' + h + '" class="currency-convert">' + h + "</span>";
                    b.unit_types.forEach(function(a) {
                        var b = "not-available";
                        a.available > 0 && (b = ""), c = c + '<span class="box-type ' + b + '">' + a
                            .unit_type + "</span>"
                    })
                } else i = "<span>NOT YET AVAILABLE</span>", c += '<span class="box-type">TBA</span>';
                c = c + '</p><p class="price">' + i +
                    '</p></div></a><p class="property-compare"><a href="#" class="btn-compare ' + f +
                    '" data-id="' + b.id + '" data-name="' + b.name + '"  data-city="' + b.city + '">', "" === f ?
                    c += "COMPARE WITH OTHER PROPERTIES" : c +=
                    '<span class="icon-home icon-check"></span>SELECTED', c += "</a></p></div></li>", a.append(c),
                    $(".fetching-loader").remove()
            }), $(".property-item-image").click(function(a) {
                a.preventDefault();
                var b = $(this).data("lat"),
                    c = $(this).data("lng");
                map.setZoom(16), map.setCenter(new google.maps.LatLng(b, c))
            }), $(".btn-compare").click(function(a) {
                a.preventDefault();
                var b = $(this).data("id"),
                    c = $(this).data("name"),
                    d = $(this).data("city");
                if ($(this).hasClass("active")) $(this).html("COMPARE WITH OTHER PROPERTIES"), $(this).removeClass(
                    "active"), comparedProperties = comparedProperties.filter(function(a) {
                    return a.id !== b
                });
                else {
                    var e = 767 > $(window).width() ? 2 : 3;
                    if (comparedProperties.length < e) {
                        $(this).html('<span class="icon-home icon-check"></span>SELECTED'), $(this).addClass(
                            "active");
                        var f = {
                            id: b,
                        ...
                        comparedProperties.push(f)
                    }
                }
                updateLocalStorage(), populateComparedProperties()
            }), updateNotActiveState(), convertCurrencies()
        }
        ...
        function updateNotActiveState() {
            ...
            var a = 767 > $(window).width() ? 2 : 3;
            comparedProperties.length >= a ? $(".btn-compare").addClass("disabled") : $(".btn-compare").removeClass(
                "disabled")
        }

        function updateNotActiveStateUnit() {
            comparedUnits.length > 0 ? $(".btn-compare-units").not(".active").each(function() {
                $(this).html('<span class="icon-home icon-add-filter"></span>ADD TO COMPARE')
            }) : $(".btn-compare-units").not(".active").each(function() {
                $(this).html("COMPARE WITH OTHER PRoperties")
            });
            var a = 767 > $(window).width() ? 2 : 3;
            comparedUnits.length >= a ? $(".btn-compare-units").addClass("disabled") : $(".btn-compare-units").removeClass(
                "disabled")
        }

        function initializeLocalStorage() {
            let a = "dmic.homes.compared_ids",
                b = "dmic.homes.compared_units_ids";
            var c = [];
            localStorage.getItem(a) && "undefined" != localStorage.getItem(a) || localStorage.setItem(a, JSON.stringify(c)),
                localStorage.getItem(b) && "undefined" != localStorage.getItem(b) || localStorage.setItem(b, JSON.stringify(
                    c)), comparedProperties = JSON.parse(localStorage.getItem(a)), comparedUnits = JSON.parse(localStorage
                    .getItem(b)), updateLocalStorage(), populateComparedProperties()
        }

        function updateLocalStorage() {
            localStorage.setItem("dmic.homes.compared_ids", JSON.stringify(comparedProperties)), localStorage.setItem(
                "dmic.homes.compared_units_ids", JSON.stringify(comparedUnits))
        }

        function populateComparedProperties() {
            comparedProperties.length > 0 && "properties" === comparedState ? $("#compared-properties-wrapper").addClass(
                "active") : $("#compared-properties-wrapper").removeClass("active");
            var e = $("#compared-properties");
            $("#compared-properties").empty();
            for (var a = "<li>               <h2>Compare Homes</h2>         </li>", f = 767 > $(window).width() ? 2 : 3, b =
                    0; b < f; b++)
                if (void 0 === comparedProperties[b]) a += "<li>              </li>";
                else {
                    var c = comparedProperties[b];
                    a = a +
                        '<li id="compare-item-1">                            <div class="compare-itemed">                               <a data-id="' +
                        c.id + '"  class="clearing jq-close"></a>                                <h3>' + c.name +
                        "</h3>                                <p>" + c.city +
                        "</p>                            </div>                        </li>"
                } var d = "";
            comparedProperties.length < 2 && (d = "disabled"), a = a +
                '<li>                 <button id="compare-now-btn" ' + d +
                '  class="btn btn-large btn-round btn-green btn-compare-all">Compare Now</button>              </li>', e
                .append(a), updateNotActiveState(), $(".compare-itemed a.clearing").click(function(c) {
                    c.preventDefault();
                    var d = $(this).data("id");
                    comparedProperties = comparedProperties.filter(function(a) {
                        return a.id !== d
                    }), updateLocalStorage(), populateComparedProperties();
                    var a = $(this).closest("li");
                    a.find("compare-itemed").remove(), a.html(
                        '<a href="#" class="btn btn-large btn-round btn-ghost btn-compare">Add</a>');
                    var b = $(".p-card[data-id=" + d + "]").find("p.property-compare").find("a.btn-compare");
                    b.removeClass("active"), b.html("COMPARE WITH OTHER PRoperties"), updateNotActiveState()
                }), $("#compare-now-btn").click(function(a) {
                    window.location = "/compare-homes"
                })
        }

        function populateComparedUnits() {
            comparedUnits.length > 0 && "units" === comparedState ? $("#compared-units-wrapper").addClass("active") : $(
                "#compared-units-wrapper").removeClass("active");
            var e = $("#compared-units");
            $("#compared-units").empty();
            for (var a = "<li>               <h2>Compare Units</h2>         </li>", f = 767 > $(window).width() ? 2 : 3, c =
                    0; c < f; c++)
                if (void 0 === comparedUnits[c]) a += "<li>              </li>";
                else {
                    var b = comparedUnits[c];
                    a = a +
                        '<li id="compare-item-1">                            <div class="compare-itemed-units">                               <a data-property-id="' +
                        b.p_id + '" data-id="' + b.id +
                        '"  class="clearing jq-close"></a>                                <h3>' + b.name +
                        "</h3>                                <p>" + b.pname + "</p>                                <p>" + b
                        .city + "</p>                            </div>                        </li>"
                } var d = "";
            comparedUnits.length < 2 && (d = "disabled"), a = a +
                '<li>                 <button id="compare-now-units-btn" ' + d +
                '  class="btn btn-large btn-round btn-green btn-compare-all">Compare Now</button>              </li>', e
                .append(a), updateNotActiveStateUnit(), $(".compare-itemed-units a.clearing").click(function(c) {
                    c.preventDefault();
                    var d = $(this).data("id");
                    comparedUnits = comparedUnits.filter(function(a) {
                        return a.id !== d
                    }), updateLocalStorage(), populateComparedUnits();
                    var a = $(this).closest("li");
                    a.find("compare-itemed-units").remove(), a.html(
                        '<a href="#" class="btn btn-large btn-round btn-ghost btn-compare">Add</a>');
                    var b = $(".unit-card[data-id=" + d + "]").find("p.units-compare").find("a.btn-compare-units");
                    b.removeClass("active"), b.html("COMPARE WITH OTHER PRoperties"), updateNotActiveStateUnit()
                }), $("#compare-now-units-btn").click(function(a) {
                    "units" === comparedState ? window.location = "/compare-homes?type=units" : window.location =
                        "/compare-homes"
                })
        }
        ...
        function sortByPriceAsc(a, b) {
            return $(b).data("min") < $(a).data("min") ? 1 : -1
        }

        function sortByPriceDesc(a, b) {
            return $(b).data("max") > $(a).data("max") ? 1 : -1
        }
        ...
        function initializeButtons() {
            var a = $("#show-more-button");
            a.hide(), a.click(function() {
                page++, clearProperty = !1, getPropertiesAndUnits().then(function(a, b) {
                    applyFilter()
                })
            });
            var b = $("#show-more-units-button");
            b.hide(), b.click(function() {
                unitPage++, clearUnits = !1, getUnits()
            }), $("#unit-result-button").click(function(a) {
                a.preventDefault(), $("#property-list-view").fadeOut(), $("#unit-list-view").fadeIn(), $(
                        "#sort-units").show(), $("#sort-properties").hide(), $("#count").hide(), $("#count-units")
                    .fadeIn(), resetActiveResultSelection(), $(this).closest("li").addClass("active"),
                    comparedState = "units", populateComparedUnits(), populateComparedProperties()
            }), $("#property-result-button").click(function(a) {
                a.preventDefault(), $("#unit-list-view").fadeOut(), $("#property-list-view").fadeIn(), $(
                        "#sort-units").hide(), $("#sort-properties").show(), resetActiveResultSelection(), $(
                        "#count-units").hide(), $("#count").fadeIn(), $(this).closest("li").addClass("active"),
                    comparedState = "properties", populateComparedProperties(), populateComparedUnits()
            });
            var c = $("#result-sort-select");
            c.change(function() {
                var b = c.val(),
                    a = $("#property-list-wrapper");
                "name_up" === b && a.find("li").sort(sortByNameAsc).appendTo(a), "name_down" === b && a.find("li")
                    .sort(sortByNameDesc).appendTo(a), "price_up" === b && a.find("li").sort(sortByPriceAsc)
                    .appendTo(a), "price_down" === b && a.find("li").sort(sortByPriceDesc).appendTo(a)
            });
            var d = $("#result-sort-select-unit");
            d.change(function() {
                var b = d.val(),
                    a = $("#unit-list-wrapper");
                "name_up" === b && a.find("li").sort(sortByNameAsc).appendTo(a), "name_down" === b && a.find("li")
                    .sort(sortByNameDesc).appendTo(a), "price_up" === b && a.find("li").sort(sortByPriceAsc)
                    .appendTo(a), "price_down" === b && a.find("li").sort(sortByPriceDesc).appendTo(a),
                    "size_up" === b && a.find("li").sort(sortBySizeAsc).appendTo(a), "size_down" === b && a.find(
                        "li").sort(sortBySizeDesc).appendTo(a)
            }), $(".dev-checkbox").change(function() {
                page = 1, unitPage = 1, selectedDev = [], $(".btn-clear").css({
                    visibility: "hidden",
                    "pointer-event": "none"
                }), $(".btn-select").css({
                    visibility: "hidden",
                    "pointer-event": "none"
                }), $("#select-all-dev").removeClass("active"), $("#clear-dev").removeClass("active"), $(
                    ".btn-apply-filter").addClass("disabled"), $(".dev-checkbox").each(function(b) {
                    if ($(this).is(":checked")) {
                        var a = $(this).val();
                        selectedDev.push(a)
                    }
                }), getPropertiesAndUnits()
            }), $("#select-all-dev").click(function(a) {
                $(this).hasClass("active") || !1 !== isBusyFetching || ($(".btn-clear").css({
                        visibility: "hidden",
                        "pointer-event": "none"
                    }), $("#simple-filter-dev").find(".dev-checkbox").prop("checked", !0), $(".dev-checkbox")
                    .each(function(b) {
                        var a = $(this).val();
                        selectedDev.push(a)
                    }), getPropertiesAndUnits(), $(this).addClass("active"), $("#clear-dev").removeClass(
                        "active"), $(".btn-apply-filter").addClass("disabled"))
            }), $("#clear-dev").click(function(a) {
                $(this).hasClass("active") || !1 !== isBusyFetching || ($(".unit-count-btn").html(
                        "<span>0</span> unit found"), $(".property-count-btn").html(
                        "<span>0</span> property found"), $("#simple-filter-dev").find(".dev-checkbox").prop(
                        "checked", !1), units = [], $(this).addClass("active"), $("#select-all-dev")
                    .removeClass("active"), $(".btn-apply-filter").addClass("disabled"))
            }), $(".btn-apply-filter").click(function() {
                $(".fetching-loader-filter").addClass("loading"), setTimeout(function() {
                    applyFilter()
                }, 100)
            })
        }

        function resetActiveResultSelection() {
            $(".result-action").each(function() {
        ...
        function getSearchType() {
            ...
            null === a && getPropertiesAndUnits().then(function(a) {
                applyFilter()
            }), "simple" === a && searchSimplePropertiesAndUnits(), "advance" === a && searchAdvancePropertiesAndUnits()
        }

        function initializePriceFilter() {
            var a = $("#min-price-select"),
                b = $("#max-price-select"),
                c = document.getElementById("noUiSlider-1");
            a.change(function() {
                changePrice()
            }), b.change(function() {
                changePrice()
            }), $("#reset-price").click(function(d) {
                d.preventDefault(), a.val("0"), b.val("20"), c.noUiSlider.set([0, 21])
            })
        }
        ...
        function changePrice() {
            var a = $("#min-price-select"),
                b = $("#max-price-select");
            selectedMinPrice = a.val(), selectedMaxPrice = b.val(), getPropertiesAndUnits()
        }
        ...
        function showMapFinder(e) {
            ...
            positionMarker = new google.maps.Marker({
                    ...
                    .longitude, placeMarkerAndPanTo(new google.maps.LatLng(a, b)), geocode(new google.maps.LatLng(a, b))),
                locationMap.addListener("click", function(a) {
                    placeMarkerAndPanTo(a.latLng, locationMap), geocode(a.latLng)
                }), positionMarker.setVisible(!0), google.maps.event.addListener(positionMarker, "dragend", function(a) {
                    placeMarkerAndPanTo(a.latLng, locationMap), geocode(a.latLng)
                });
        ...
        $(document).ready(function() {
            loadCitiesSearch(), loadUnits(), loadStatus(), initializePriceFilter()
        }), $(function() {
            getSearchType(), initializeLocalStorage()
        }), initializeButtons()
    </script>
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB9Grs79R5BcpwGaHoOEGMVhXduY_hd3uc&libraries=places&callback=initMap"
        async defer></script>
