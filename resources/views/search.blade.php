 ...
 <!--Start of Tawk.to Script-->
    ...
    <section id="main-container" class="">
        ...
        <figure class="logo">
            ...
            <nav class="main-nav">
                <ul>
                    ...
                    <li><a href="{{ route('prop') }}">Properties</a></li>
                                        ...
                                        <div class="price-range">
                                            ...
                                            <p class="pricing-label clear">
                                                <label class="pl-1 fl" for=""
                                                    ...
                                                    </span> <span id="budget-min-price-label-2">5,
                                                    </span><span>,000</span></label>
                            ...
                            <div class="col-md-4" data-search-option="buy">
                                <div class="input-wrap">
                                    ...
                                    <div class="price-range">
                                        ...
                                        <input type="hidden" id="qs-min-price-1" name="price_fm"
                                            class="price_fm" />
                                        <input type="hidden" id="qs-max-price-1" name="price_to"
                                            class="price_to" />
        ...
        <nav class="rightbar-nav animated hiding" data-animation="fadeInRight" data-delay="700">
            ...
            <ul>
                <li><a href="#high-condominiums">High Rise Condominiums</a></li>
                    ...
                    <div class="property-list folio-map">
                        ...
                        <ul class="flex">
                            ...
                            <li class="p-card box-card" data-id="1" data-city="Quezon City"
                                data-min="6254000.00" data-max="12885000.00" data-name="Accolade Place"><a
                                    href="#" class="icon-share pi-share"
                                    data-url="accolade-place"><span>Share</span></a>
                                <div class="property-item">
                                    <a href="{{ asset($mid->image) }}">
                                        <figure class="property-img">
                                            <img src="{{ asset($mid->image) }}" alt="mid Image" width="100">
                                        </figure>
                                        <div class="content">
                                            <h3>{{ $mid->name }}</h3>
                                            <p>{{ $mid->place }}</p>
                                            ...
                                            <p class="price"> {{ $mid->price }}</span></p>
                                        </div>
                                        <p class="property-compare">
                                            <a href="" class="btn-compare" data-id="1"
                                                data-name="Accolade Place" data-city="Quezon City">
                                                <span class="icon-home icon-add-filter"></span>
                                                ADD TO COMPARE
                                            </a>
                                        </p>
                                    </a>
                    ...
                    <div class="property-list folio-map">
                        <div class="sec-head">
                            ...
                            <p>Experience the joy of living among fields of lush greens, along wide avenues, in a secure
                                and safe environment at DMCI Homes' subdivisions.</p>
                        </div>
                        ...
                        <ul class="flex">
                            ...
                            <li class="p-card box-card" data-id="31" data-city="Taguig" data-min="5625000.00"
                                ...
                                <div class="property-item">
                                    <a href="{{ asset($subdivision->image) }}">
                                        <figure class="property-img">
                                            <img src="{{ asset($subdivision->image) }}" alt="subdivision Image" width="100">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="price">{{ $subdivision->price }}</p>
                                        </div>
                                        <p class="property-compare">
                                            <a href="#" class="btn-compare" data-id="31"
                                                data-name="Mahogany Place III" data-city="Taguig">
                                                <span class="icon-home icon-add-filter"></span>
                                                ADD TO COMPARE
                                            </a>
                                        </p>
                ...
                <div class="container">
                    <div class="property-list folio-map">
                        <div class="sec-head">
                            ...
                            <p>At Alta Vista de Boracay, life's more than just a beach. It's a well-appointed condo with more than just your average amenities.</p>
                        </div>
                        <ul class="flex">
                            @foreach($leisureItems as $leisure)
                            <li class="p-card box-card" data-id="6" data-city="Malay" data-min="5487000.00" data-max="9241000.00" data-name="Alta Vista de Boracay">
                                <a href="#" class="icon-share pi-share" data-url="alta-vista-de-boracay">
                                    <span>Share</span>
                                </a>
                                <div class="property-item">
                                    <a href="{{ asset($leisure->image) }}">
                                        <figure class="property-img">
                                            <img src="{{ asset($leisure->image) }}" alt="leisure Image" width="100">
                                            <span class="property-status circle-white">
                                                <span class="icon-home rfo icon-RFO"></span>
                                            </span>
                                        </figure>
                                        <div class="content">
                                            ...
                                            <p class="price">{{ $leisure->price }}</p>
                                        </div>
                                    </a>
                                    <p class="property-compare">
                                        <a href="alta-vista-de-boracay"></a>
                                        <a href="#" class="btn-compare" data-id="6" data-name="Alta Vista de Boracay" data-city="Malay">COMPARE WITH OTHER PROPERTIES</a>
                                    </p>
                                </div>
                            </li>
                            @endforeach
            ...
            <section class="sec-pad sec-default jq-section" id="cities">
                <div class="container">
                    <div class="sec-head">
                        ...
                        <p>Check out other properties within striking distance of the metro's bustling business and commercial centers.</p>
                    </div>
                        ...
                        <div class="masonry-wrap">
                            <div class="grid" id="media-news-wrapper">
                                ...
                                <div class="grid-item" data-animation="fadeInUp">
                                    <a href="https://www.dmcihomes.com/condo-{{ $city->place }}">
                                ...
                                <ul>
                                    <li class="animated hiding" data-animation="fadeInUp">
                                        <figure><img class="lazyload"
                                                src="{{asset('images/lazyload.png')}}"
                                                data-src="{{asset('images/icon-call.png')}}')}}"
                                    ...
                                    <li class="animated hiding" data-animation="fadeInUp">
                                        <figure><img class="lazyload"
                                                src="{{asset('images/lazyload.png')}}"
                                                data-src="{{asset('images/icon-email.png')}}')}}"
                                                alt="" width="40" height="40"></figure>
                                ...
                                <ul>
                                    ...
                                    <li class="qq-wrap">
                                        ...
                                        <a data-fancybox-image-qr data-src="#qq-brand" class="hide-desktop">
                                            <img class="lazyload" src="{{asset('images/lazyload.png')}}"
                                                data-src="{{asset('images/qq.png')}}" width="24"
                                                height="28" alt="">
                                        </a>
                                    </li>
